...
class Coin(models.Model):  # Модель для таблицы монет
    coin_id = models.CharField(max_length=100, unique=True)  # id для парсинга с API
    coin_name = models.CharField(max_length=100)  # название для отображения в кнопках
